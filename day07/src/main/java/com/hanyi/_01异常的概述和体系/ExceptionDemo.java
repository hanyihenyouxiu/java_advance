 ...
 *      异常是应该尽量提前避免的。
 *      异常可能也是无法做到绝对避免的，异常可能有太多情况，开发中只能提前干预！
 ...
 *      Error：错误的意思，严重错误Error，无法通过处理的错误，一旦出现，程序员业务能为力，
 *          只能重启程序，优化项目。
 *          比如内存崩溃，JVM本身的崩溃。这个程序员无需理会。
 *
 *      Exception：才是异常类，它才是开发有代码在编译或者执行的过程中可能出现的错误。
 *          它是需要提前处理的。已便程序更健壮！
 * Exception异常的分类：
 ...
 *  异常一旦真的出现，程序会终止，所以要研究异常，避免一场，处理异常，程序才能更健壮！！！
 */
